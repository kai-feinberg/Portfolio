...
const BentoCard = ({
  ...
  >
    ...
    <div className="relative z-20 p-4 h-full flex flex-col justify-end">
      ...
      >
        <Button
          ...
          asChild
          size="sm"
          className="pointer-events-auto p-0 text-white hover:text-neutral-300"
        >
          <a href={href}>
            {cta}
    ...
    <div className="pointer-events-none absolute inset-0 z-40 transform-gpu transition-all duration-300 group-hover:bg-black/[.1]" />
  </div>
);
